...
insert into job_Ad(BENEFITS, BUSINESS_AREA, CONTACT_INFO, DESCRIPTION, EDUCATION_LEVEL_REQUIRED, REQUIREMENTS, EMPLOYER_ID, LOCATION_ID, STATUS ) values ('Vale-refeição e Vale transporte', 'Informática TI',  'rh@bol.com.br', 'Nível hierárquico: Operacional, Regime de contratação de tipo Efetivo – CLT Jornada Período Integral', 'Ensino Superior',  'Escolaridade Mínima: Ensino Superior Inglês (Intermediário - Requerido) Programação: C#, JavaScript, jQuery, PHP', 8, 2, 'Approved');
insert into job_Ad(BENEFITS, BUSINESS_AREA, CONTACT_INFO, DESCRIPTION, EDUCATION_LEVEL_REQUIRED, REQUIREMENTS, EMPLOYER_ID, LOCATION_ID, STATUS ) values ('Meal ticket and Health Insurance', 'IT',  'rh.it@gmail.com', 'IT MANAGER - Maintains information technology strategies by managing staff; researching and implementing technological strategic solutions.', 'Graduation in IT area',  'Knowledge of English and French; Data Center Management, Developing Budgets, Coordination; Java, JavaScript, Spring, SCRUM, SQL', 8, 3, 'Waiting');
insert into job_Ad(BENEFITS, BUSINESS_AREA, CONTACT_INFO, DESCRIPTION, EDUCATION_LEVEL_REQUIRED, REQUIREMENTS, EMPLOYER_ID, LOCATION_ID, STATUS ) values ('Health Insurance and Place for Meal', 'IT',  'rh.it@gmail.com', 'JAVA DEVELOPER - Creates user information solutions by developing, implementing, and maintaining Java based components and interfaces.', 'Graduation in progress in IT area',  'Knowledge of English; Java, Java Applets, Web Programming Skills, Teamwork, Verbal Communication, Software Debugging, Spring, SCRUM, SQL', 8, 3, 'Waiting');
insert into job_Ad(BENEFITS, BUSINESS_AREA, CONTACT_INFO, DESCRIPTION, EDUCATION_LEVEL_REQUIRED, REQUIREMENTS, EMPLOYER_ID, LOCATION_ID, STATUS ) values ('Transportation Vouchers', 'Marketing',  'rh.marketing@gmail.com', 'MARKETING ASSISTANT - Supports marketing operations by compiling, formatting, and reporting information and materials.', 'Graduation in progress',  'Written Communication, Organization, Statistical Analysis, General Math, Microsoft Office, Self-Development, Financial Skills', 1, 1, 'Waiting');
insert into job_Ad(BENEFITS, BUSINESS_AREA, CONTACT_INFO, DESCRIPTION, EDUCATION_LEVEL_REQUIRED, REQUIREMENTS, EMPLOYER_ID, LOCATION_ID, STATUS ) values ('Meal ticket and Transportation Vouchers', 'IT',  'rh.it@gmail.com', 'IT TECHNICIAN - Serves customers by installing and servicing systems and products.', 'Technical Course in IT area', 'Knowledge of English (basic level); Electronics Troubleshooting, Equipment Maintenance, Reporting Skills, Confidentiality, Quality Focus', 9, 1, 'Approved');
insert into job_Ad(BENEFITS, BUSINESS_AREA, CONTACT_INFO, DESCRIPTION, EDUCATION_LEVEL_REQUIRED, REQUIREMENTS, EMPLOYER_ID, LOCATION_ID, STATUS ) values ('Meal ticket and Transportation Vouchers', 'IT',  'it123@gmail.com', 'DATABASE ARCHITECT - Maintains database by determining structural requirements; developing and installing solutions.', 'Graduation in IT area', 'Knowledge of English and Spanish; Database Design, Data Maintenance, Database Security, Database Management, Requirements Analysis, Teamwork; Oracle SQL, PostgreSQL, MySQL', 9, 1, 'Waiting');
