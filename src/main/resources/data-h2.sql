...
insert  into article (id,  active, body , picture , posted_on , slug , teaser , title , user_id ) values (1, true,'hjhjfhjh jkojiojikj bhhgfhgh kjkijikjikjoi', null, sysdate,'Linguagens-JPA-JSF','hhhhh', 'JPA, JSF e Spring Tool Boot', 2) ;
