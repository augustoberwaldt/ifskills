...
insert into job_Ad(BENEFITS, BUSINESS_AREA, CONTACT_INFO, DESCRIPTION, EDUCATION_LEVEL_REQUIRED, REQUIREMENTS, EMPLOYER_ID, LOCATION_ID ) values ('Vale-refeição e Vale transporte', 'Informática TI',  'rh@bol.com.br', 'Nível hierárquico: Operacional, Regime de contratação de tipo Efetivo – CLT Jornada Período Integral', 'Ensino Superior',  'Escolaridade Mínima: Ensino Superior Inglês (Intermediário - Requerido) Programação: C#, JavaScript, jQuery, PHP', 8, 2)
